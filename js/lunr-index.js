...
index.addDoc({
  ...
  "summary": "Professor Tyndall and Dwight Miner at the publication party for the Columbia Encyclopedia."
});
index.addDoc({
  "lunr_id": 8,
  "link": "{{ site.baseurl }}/photos/16/",
  "pid": "16",
...
index.addDoc({
  ...
  "summary": "View of Butler Library at night as viewed from across 116th Street, November 1937."
});
index.addDoc({
  "lunr_id": 12,
  "link": "{{ site.baseurl }}/photos/2/",
  "pid": "2",
...
index.addDoc({
  ...
  "summary": "31 August 1934. Boxes of books loaded onto the book chute next to the Alma Mater on their way across campus. Between August 20 and September 19, 1934 student workers and professional movers moved books from their original home in Low Library to their new home in South Hall (Butler Library)."
});
index.addDoc({
  "lunr_id": 15,
  "link": "{{ site.baseurl }}/photos/22/",
  "pid": "22",
...
index.addDoc({
  ...
  "summary": "Detail view of the ceiling in the Butler Library of Philosophy located in South Hall (Butler Library), ca. 1934."
});
index.addDoc({
  "lunr_id": 17,
  "link": "{{ site.baseurl }}/photos/24/",
  "pid": "24",
  "title": "Book Transfer",
  ...
  "_name": "Sprague",
  "subjects": "College campuses; New York (N.Y.)",
  "summary": "Image of student workers moving boxes from book chutes onto book carts at the foot of stairs to Low Plaza. Between August 20 and September 19, 1934 student workers and professional movers moved books from their original home in Low Library to their new home in South Hall (Butler Library)."
});
index.addDoc({
  "lunr_id": 18,
  "link": "{{ site.baseurl }}/photos/25/",
  "pid": "25",
  "title": "Browsing Room",
  "_date": "between 1934 and 2009",
  "format": "photographs",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.); Butler Library",
  "summary": "Main transverse stack aisle showing continuous beam less ceiling and tile covered floor, ca. 1930s."
});
index.addDoc({
  "lunr_id": 20,
  "link": "{{ site.baseurl }}/photos/27/",
  "pid": "27",
  "title": "Columbia' Gate",
  "_date": "between 1934 and 2009",
  "format": "photographs",
...
index.addDoc({
  "lunr_id": 21,
  "link": "{{ site.baseurl }}/photos/28/",
  "pid": "28",
  "title": "Butler Library - Main entrance mural",
  "_date": "between 1934 and 2009",
  "format": "photographs",
  "_name": "Look magazine",
  "subjects": "Academic libraries; Mural painting and decoration; New York (N.Y.); Butler Library",
  "summary": "Man and woman on bench in front of the main entrance mural of Athene painted by  Eugene Savage of the Yale School of Fine Arts. Attributed to Look Magazine"
});
index.addDoc({
  "lunr_id": 22,
  "link": "{{ site.baseurl }}/photos/29/",
  "pid": "29",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.); Butler Library",
  "summary": "Image of (L to R) Pierre Douzelot, President Grayson Kirk, Jean Sarrailk, and Henri Bonnet examining a part of the exhibit of French Universities at Butler Library, 18 October 1954."
});
index.addDoc({
  "lunr_id": 27,
  "link": "{{ site.baseurl }}/photos/33/",
  "pid": "33",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.)",
  "summary": "A student working with some of the rare publications dealing with the Russian Revolutionary Movement, purchased by Columbia University from funds granted by the Rockefeller Foundation."
});
index.addDoc({
  "lunr_id": 34,
  "link": "{{ site.baseurl }}/photos/4/",
  "pid": "4",
  "title": "Butler Library Construction Pit",
  "_date": "before 1931",
  "format": "photographs",
...
index.addDoc({
  ...
  "_name": "Wurts Bros. (New York, N.Y.)",
  "subjects": "Academic libraries; Reading rooms; New York (N.Y.); Butler Library",
  "summary": "View of the Butler Library of Philosophy located in South Hall (Butler Library), ca. 1934."
});
index.addDoc({
  "lunr_id": 38,
  "link": "{{ site.baseurl }}/photos/43/",
  "pid": "43",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.)",
  "summary": "Delivery desk station near a book conveyor with gravity discharge in South Hall (Butler Library)"
});
index.addDoc({
  "lunr_id": 45,
  "link": "{{ site.baseurl }}/photos/5/",
  "pid": "5",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.)",
  "summary": "View from below of one of the exterior light fixtures on the front of Butler Library."
});
index.addDoc({
  "lunr_id": 47,
  "link": "{{ site.baseurl }}/photos/51/",
  "pid": "51",
...
index.addDoc({
  ...
  "summary": "'While Columbia University guards were lunching early today [September 25, 1936], a well-organized squad of vandals daubed this red curtain of paint on the university's new library.  Work was believed done either by painters' union or students sympathizing with Bob Burke expulsion.  Paint is stain that 'sticks.''"
});
index.addDoc({
  "lunr_id": 50,
  "link": "{{ site.baseurl }}/photos/54/",
  "pid": "54",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.); Butler Library",
  "summary": "View of Butler Library main entrance, with a Columbia security vehicle and a kid in the foreground."
});
index.addDoc({
  "lunr_id": 52,
  "link": "{{ site.baseurl }}/photos/56/",
  "pid": "56",
...
index.addDoc({
  ...
  "summary": "President Nicholas Murray Butler handing out a Craftsmanship Award in front of South Hall (Butler Library), 1934."
});
index.addDoc({
  "lunr_id": 54,
  "link": "{{ site.baseurl }}/photos/58/",
  "pid": "58",
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.); Butler Library",
  "summary": "Students playing football or possible rugby on lawn in front of Journalism Building with Butler Library in the background."
});
index.addDoc({
  "lunr_id": 55,
  "link": "{{ site.baseurl }}/photos/59/",
  "pid": "59",
  ...
  "_name": "Rothschild, Albert",
  "subjects": "Academic libraries; Award presentations; New York (N.Y.); Butler Library",
  "summary": "Group photograph of the 1934 Craftsmanship Award winners with President Nicholas Murray Butler in front of South Hall (Butler Library)."
});
index.addDoc({
  "lunr_id": 56,
  "link": "{{ site.baseurl }}/photos/6/",
  "pid": "6",
  "title": "Butler Library at Night",
  "_date": "1941",
  "format": "photographs",
...
index.addDoc({
  ...
  "summary": "Two scholars (one of whom is Professor John Day) looking at papyrus with magnifying glass in the Rare Book and Manuscript Library."
});
index.addDoc({
  "lunr_id": 58,
  "link": "{{ site.baseurl }}/photos/61/",
  "pid": "61",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.); Butler Library",
  "summary": "18 May 1977 Commencement ceremony. Procession of University Trustees from Butler Library to Low Plaza."
});
index.addDoc({
  "lunr_id": 60,
  "link": "{{ site.baseurl }}/photos/63/",
  "pid": "63",
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.)",
  "summary": "Woman looking at bulletin board containing examples of the media coverage for Columbia University's Bicentennial in 1954."
});
index.addDoc({
  "lunr_id": 61,
  "link": "{{ site.baseurl }}/photos/64/",
  "pid": "64",
...
index.addDoc({
  "lunr_id": 67,
  "link": "{{ site.baseurl }}/photos/7/",
  "pid": "7",
  "title": "For Columbia Theater, A Festive First Night,' Article in the New York Times, September 17, 1988.",
  "_date": "17-Sep-88",
  "format": "clippings",
...
index.addDoc({
  ...
  "_name": "Wurts Bros. (New York, N.Y.)",
  "subjects": "Academic libraries; Reading rooms; New York (N.Y.); Butler Library",
  "summary": "View of the Business Library Reading Room in South Hall (Butler Library), ca. 1934."
});
index.addDoc({
  "lunr_id": 70,
  "link": "{{ site.baseurl }}/photos/72/",
  "pid": "72",
...
index.addDoc({
  ...
  "_name": "Sprague",
  "subjects": "College campuses; New York (N.Y.)",
  "summary": "View of one portion of the book conveyor system from behind the Alma Mater statue on Low Plaza. Between August 20 and September 19, 1934 student workers and professional movers moved books from their original home in Low Library to their new home in South Hall (Butler Library)."
});
index.addDoc({
  "lunr_id": 75,
  "link": "{{ site.baseurl }}/photos/77/",
  "pid": "77",
...
index.addDoc({
  ...
  "summary": "'Theodore Shabad, assistant editor of the Gazetteer, checks data on source which include a Communist atlas published in 1950, and the China Postal Guide in both Chinese and English editions. '"
});
index.addDoc({
  "lunr_id": 80,
  "link": "{{ site.baseurl }}/photos/81/",
  "pid": "81",
  "title": "Butler Library - Looking West",
  "_date": "between 1934 and 2009",
  "format": "photographs",
...
index.addDoc({
  ...
  "_name": "",
  "subjects": "Academic libraries; New York (N.Y.); Butler Library",
  "summary": "1953 Columbia graduate, holding two children, having his picture taken after the ceremony is over."
});
index.addDoc({
  "lunr_id": 85,
  "link": "{{ site.baseurl }}/photos/86/",
  "pid": "86",
  "title": "Browsing Room",
  "_date": "circa 1934",
  "format": "photographs",
...
index.addDoc({
  ...
  "_name": "Wurts Bros. (New York, N.Y.)",
  "subjects": "Academic libraries; Reading rooms; New York (N.Y.); Butler Library",
  "summary": "View of people sitting in an alcove in South Hall (Butler Library) browsing room, ca. 1934."
});
index.addDoc({
  "lunr_id": 89,
  "link": "{{ site.baseurl }}/photos/9/",
  "pid": "9",
...
index.addDoc({
  ...
  "summary": "'Students pore over a display of 'Banned Books of All Ages' in Butler Library at Columbia University which is observing its 200th anniversary throughout 1954.'"
});
index.addDoc({
  "lunr_id": 94,
  "link": "{{ site.baseurl }}/photos/94/",
  "pid": "94",
